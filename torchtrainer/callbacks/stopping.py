...
class EarlyStopping(Callback):
    ...
    """
    UNRECOGNIZED_MODE_MESSAGE = "Unrecognized mode {mode}. Options are: 'max', 'min'"
    ...
    def __init__(self, monitor, min_delta=0, patience=0, mode='min'):
        ...
        Arguments:
            ...
            mode(str): One of 'max' or 'min'. Alters the improvement criterion
        ...
        try:
            self._has_improved = criterion_by_mode[mode]
        except KeyError:
